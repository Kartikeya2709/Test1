<x-guest-layout>
    ...
    <div class="w-full max-w-md mx-auto mt-10  p-8 rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="text-center mt-4">
                <a class="text-sm text-blue-600 hover:underline" href="{{ route('login') }}">Already have an account?</a>
            </div>
        </form>
    </div>
</x-guest-layout>
